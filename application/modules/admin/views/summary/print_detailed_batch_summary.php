 <style>
    ...
    <table>
        ...
        <tbody>
            <!-- Details for N1117 - Prepare for Booking -->
            <tr>
                <td>1</td>
                <td>To Book a package ____stationary is required by Consignment Booking Assistant</td>
                <td>8</td>
                <td>All of the above</td>
                <td>All of the above</td>
                <td><p>&#10004;</p></td>
            </tr>
            <!-- Add more rows for N1117 questions -->
            <!-- Details for N1118 - Perform Consignment Booking -->
            <tr>
                <td>11</td>
                <td>To book a truck the correct sequence of events are</td>
                <td>6</td>
                <td>Contact Transport Company, Check for availability, Hold a Booking</td>
                <td>Contact Transport Company, Check for availability, Hold a Booking</td>
                <td><p>&#10006;</p></td>
            </tr>
            <!-- Add more rows for N1118 questions -->
            <!-- Details for N1119 - Perform Post Booking Activities -->
            <tr>
                <td>21</td>
                <td>Delays in travel has to be informed to __</td>
                <td>8</td>
                <td>Transport Manager</td>
                <td>Transport Manager</td>
                <td></td>
            </tr>
            <!-- Add more rows for N1119 questions -->
            <!-- Details for N1128 - Maintain Health Safety and Security Measures While Booking Consignments -->
            <tr>
                <td>31</td>
                <td>In emergency situation __ must be followed</td>
                <td>6</td>
                <td>Protocols</td>
                <td>Protocols</td>
                <td></td>
            </tr>
            <!-- Add more rows for N1128 questions -->
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>1</td>
                <td>How do you deal with the issues arising out of the job</td>
                <td>9</td>
                <td>12</td>
            </tr>
