        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
               <p>Copyright © <a href="https://www.pvrscpl.in/" target="_blank">PVR Skill Central</a></p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
	...
	<script src="<?php echo base_url(); ?>assets/admin/vendor/datatables/js/dataTables.buttons.min.js"></script>
	<script src="<?php echo base_url(); ?>assets/admin/vendor/datatables/js/buttons.html5.min.js"></script>
	<script src="<?php echo base_url(); ?>assets/admin/vendor/datatables/js/jszip.min.js"></script>
