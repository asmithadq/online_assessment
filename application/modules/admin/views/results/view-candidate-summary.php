			...
			<div class="col-xl-12 col-lg-12">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title">Result Summary - Candidate</h4>
						<div class="bootstrap-badge"> <a href="javascript:void(0)" class="badge badge-info" onclick="download_result_summary('Basic')"><i class="fa-solid fa-file-pdf"></i> Download Basic Result</a> <a href="javascript:void(0)" class="badge badge-info" onclick="download_result_summary('Detailed')"><i class="fa-solid fa-file-pdf"></i> Download Detailed Result</a> </div>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-7">
								<div class="card">
									<div class="card-body">
										...
										<?php
                                        //$watermark_file = str_replace(".jpeg", "-watermark.jpeg", $arr_student_details['student_photo']);
										$student_photo_file = $arr_student_details['student_photo'];
                                        $student_watermark_photo = ($arr_student_details['student_photo'] != "") ? base_url() . $this->config->item('student_photo_path') . $student_photo_file : base_url() . 'assets/admin/images/profile/small/pic8.jpg';
                        
                                        //$watermark_aadhar_front_file = str_replace(".jpeg", "-watermark.jpeg", $arr_student_details['aadhar_front_filename']);
										$aadhar_front_file = $arr_student_details['aadhar_front_filename'];
                                        $aadhar_front_watermark_photo = ($arr_student_details['aadhar_front_filename'] != "") ? base_url() . $this->config->item('aadhaar_filename_path') . $aadhar_front_file : base_url() . 'assets/admin/images/profile/small/pic8.jpg';
                        
                                        //$watermark_aadhar_back_file = str_replace(".jpeg", "-watermark.jpeg", $arr_student_details['aadhar_back_filename']);
										$aadhar_back_file = $arr_student_details['aadhar_back_filename'];
                                        $aadhar_back_watermark_photo = ($arr_student_details['aadhar_back_filename'] != "") ? base_url() . $this->config->item('aadhaar_filename_path') . $aadhar_back_file : base_url() . 'assets/admin/images/profile/small/pic8.jpg';
                                        ?> 
											<ul class="list-unstyled">
												<li><strong>Candidate ID:</strong>
													<?php echo $arr_student_details['enrollment_number']; ?>
												</li>
												<li><strong>Student Name:</strong>
													<?php echo $arr_student_details['student_name']; ?>
												</li>
												<li><strong>Father Name:</strong>
													<?php echo $arr_student_details['father_name']; ?>
												</li>
												<li><strong>Date of Birth:</strong>
													<?php echo (!empty($arr_student_details['dob'])) ? date('d-m-Y',strtotime($arr_student_details['dob'])) : ""; ?>
												</li>
												<li><strong>Aadhar Number:</strong>
													<?php echo $arr_student_details['aadhar_number']; ?>
												</li>
												<li class="d-flex">
												...
												<li><strong>Address:</strong>
													<?php echo $arr_student_details['address']; ?>
												</li>
												<li><strong>Geo Location Details:</strong> Latitude -
													<?php echo $arr_student_details['lat']; ?>, Longitude -
														<?php echo $arr_student_details['lng']; ?>
												</li>
											</ul>
									</div>
								</div>
									...
									<div class="card-body">
										...
										<ul class="list-unstyled">
											<li><strong>Training Partner Name:</strong>
												<?php echo $arr_student_details['tp_name']; ?>
											</li>
											<li><strong>Training Center Name:</strong>
												<?php echo $arr_student_details['tc_name']; ?>
											</li>
											<li><strong>Batch Name:</strong>
												<?php echo $arr_student_details['batch_id']; ?>
											</li>
											<li><strong>Assessment Date:</strong>
												<?php echo date('d-m-Y', strtotime($arr_student_details['tb_assessment_date'])); ?>
											</li>
											<li><strong>Sector Skill Council:</strong>
												<?php echo $arr_student_details['ssc_code'] . "-" . $arr_student_details['ssc_title']; ?>
											</li>
											<li><strong>Trade/QP Name:</strong>
												<?php echo $arr_student_details['trade_code'] . "-" . $arr_student_details['trade_name']; ?>
											</li>
										</ul>
										<hr>
										<h4 class="card-title">Result Information</h4>
										<ul class="list-unstyled">
											<li><strong>Passing Percentage:</strong>
												<?php echo $arr_student_details['pass_percentage']; ?>%</li>
											<li><strong>User Percentage:</strong>
												<?php echo $arr_student_details['marks_percentage']; ?>%</li>
											<li><strong>Result:</strong>
												<?php
                                                if ($arr_student_details['result'] == 'Pass') {
                                                    ?> <span class="badge badge-rounded badge-success">Pass</span>
													<?php
                                                } else if ($arr_student_details['result'] == 'Fail') {
                                                    ?> <span class="badge badge-rounded badge-danger">Fail</span>
														<?php
                                                } else if ($arr_student_details['result'] == 'Absent') {
								...
								<?php
                                    if ($arr_snapshot_details != false) {
                                        ...
                                        foreach ($arr_snapshot_details as $details) {
                                            ...
                                            ?>
									<li style="list-style-type: none; display: inline; flex-wrap: wrap; justify-content: flex-start; align-items: center;"> <a href="<?php echo $snapshot_file; ?>" data-lightbox="assessment-snapshots" data-title="Assessment Snapshot">
										...
										<?php   
                                            if(count($arr_trade_nos_details) > 0) {
                                                foreach($arr_trade_nos_details as $nos_id => $nos_details) {
                                                    ...
                                                    $practical_skill_user_score = $arr_nos_wise_user_score[$nos_id]['PracticalSkill'];
                                                    $practical_activity_user_score = $arr_nos_wise_user_score[$nos_id]['PracticalActivity'];
									...
									<tbody>
                                        ...
                                        ?>
											<tr>
												...
												<td>
													<?php echo ($arr_student_details['theory_submission_dts'] != "") ? date('d-m-Y',strtotime($arr_student_details['theory_submission_dts'])) : ""; ?>
												</td>
											</tr>
											<?php
                                        }
												...
												<tr>
													...
													<td>
														...
														if($show_practical_activity == 1) {
														    $submission_dts .= (isset($arr_student_details['practicalactivity_submission_dts']) && $arr_student_details['practicalactivity_submission_dts'] != "0000-00-00") ? date('d-m-Y',strtotime($arr_student_details['practicalactivity_submission_dts'])) : "";
														}
														if($show_viva == 1) {
														    $submission_dts .= (isset($arr_student_details['viva_submission_dts']) && $arr_student_details['viva_submission_dts'] != "0000-00-00") ? "/".date('d-m-Y',strtotime($arr_student_details['viva_submission_dts'])) : "";
														}
														echo $submission_dts;
														?>
													</td>
									...
									<tbody>
                                        ...
                                        if(count($arr_theory_answers_list) > 0) {
											...
											<tr>
												...
												<td>
													<h6><?php echo $arr_qns_details[$nos_id][$qn_id]['question']; ?></h6> <small>NOS - <?php echo $nos_details['nos_code']; ?> - <?php echo $nos_details['nos_title']; ?></small> <small><?php echo $arr_theory_answers_list[$qn_id]['question_type']; ?></small> </td>
												<td>
													<?php echo $arr_theory_answers_list[$qn_id]['marks']; ?>
												</td>
                                ...
                                ?>
									...
									<div class="row align-items-center">
										<div class="col">
											...
											<?php
											if($arr_student_details['practicalactivity_video_file'] != "") {
											?>	
												<div class="col-auto">
													<button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg" onclick="getuploadedVideo('Practical Activity','<?php echo $arr_student_details['practicalactivity_video_file']  ?>');">View Uploaded Video</button>
												</div>
											<?php
											}
											?>  	
                                            ...
                                            ?>
												<tr>
													...
													<td>
														<div class="products">
															<div>
																<h6><?php echo $arr_qns_details[$nos_id][$qn_id]['question']; ?></h6> <small>NOS - <?php echo $nos_details['nos_code']; ?> - <?php echo $nos_details['nos_title']; ?></small> </div>
														</div>
													</td>
													<td>
														<?php echo $arr_practical_activity_answers_list[$qn_id]['marks']; ?>
													</td>
													<td>
														<?php echo $arr_practical_activity_answers_list[$qn_id]['max_marks']; ?>
													</td>
												</tr>
												<?php
                                                $sl_no++;
									...
									<?php } ?>
										<?php if($show_viva == 1) { ?>
											...
											<div class="row align-items-center">
												...
												<?php
												if($arr_student_details['viva_video_file'] != "") {
												?>	
												<div class="col-auto">
													<button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg" onclick="getuploadedVideo('Viva','<?php echo $arr_student_details['viva_video_file']  ?>');">View Uploaded Video</button>
												</div>
												<?php
												}
												?>
                                        ...
                                        if(count($arr_viva_answers_list) > 0) {
                                            ...
                                            ?>
														<tr>
															...
															<td>
																<?php echo $arr_viva_answers_list[$qn_id]['marks']; ?>
															</td>
															<td>
																<?php echo $arr_viva_answers_list[$qn_id]['max_marks']; ?>
															</td>
														</tr>
														<?php
                                                $sl_no++;
...
function download_result_summary(summary_type) {
	if(summary_type == 'Basic') {
		url = "<?php echo base_url().'view-result-summary/'.id_encode($arr_student_details['student_id']).'/basic_pdf' ?>";
	} else {
		url = "<?php echo base_url().'view-result-summary/'.id_encode($arr_student_details['student_id']).'/detailed_pdf' ?>";
	}
