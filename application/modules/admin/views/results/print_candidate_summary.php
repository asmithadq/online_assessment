		...
		<div class="col-xl-12 col-lg-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title" style="text-align: center;"><u>Candidate <?php echo ($type == 'detailed_pdf') ? "Detailed" : "Basic"; ?> Result Summary</u></h3> </div>
				<div class="card-body">
					<div class="row">
								...
								<tr>
									...
									<td style="border: none; vertical-align: top; line-height: 1.5;">
										...
										<ul>
											...
											<li>Result:
												<?php echo $arr_student_details['result']; ?>
											</li>
										</ul>
									</td>
								</tr>
								<tr>
									<td colspan="2" style="border: none;">
										<div class="d-inline flex-column"> 
											<strong>Photo:</strong> 
												<img class="img-thumbnail" src="<?php echo base_url().$this->config->item('student_photo_path').$arr_student_details['student_photo']; ?>" alt="Student Photo" height="75" width="75"> 
											<strong>Aadhar Front: </strong>
												<img class="img-thumbnail" src="<?php echo base_url().$this->config->item('aadhaar_filename_path').$arr_student_details['aadhar_front_filename']; ?>" alt="Aadhar Front" height="75" width="75">
											<strong>Aadhar Back:</strong> 
												<img class="img-thumbnail" src="<?php echo base_url().$this->config->item('aadhaar_filename_path').$arr_student_details['aadhar_back_filename']; ?>" alt="Aadhar Back" height="75" width="75"> 
										</div>
									</td>
								</tr>
							</tbody>
