                ...
                <div class="card">
					<div class="card-body" style="margin-top: 10px; padding: 10px;">
						...
						<div style="display: flex; align-items: center;">
							<h4 class="card-title">Question <span class="pull-end"><temp id="qnCounter">1</temp>/<?php echo $totalQuestions; ?></span></h4>
							<div class="progress mb-3" style="flex: 1; margin-left: 10px;">
								<div class="progress-bar bg-danger progress-animated" style="width: 90%; height:6px;" role="progressbar">
									<span class="sr-only">90% Complete</span>
								</div>
							</div>
							<div class="alert alert-primary solid alert-rounded" style="margin-left: 10px;" id="div_timer">
								<span id="timer">Timer: <strong>00:00:00</strong></span>
							</div>
						</div>
					</div>
					<?php
