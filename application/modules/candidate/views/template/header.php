...
<head>
   <meta charset="utf-8">
	...
	<!-- Style css -->
    <link href="<?php echo base_url(); ?>assets/student/css/style.css" rel="stylesheet">
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black" data-headerbg="color_1">
    ...
    ********************-->
    <div id="preloader">
		<div>
			<img src="<?php echo base_url(); ?>assets/student/images/pre.gif" alt=""> 
		</div>
    </div>
    <!--*******************
        Preloader end
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
			...
			<img style="width:40px" src="<?php echo base_url(); ?>assets/student/images/logo/logo.png"/ >
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
						<div class="header-left">
							<div class="dashboard_bar">
                               <?php echo $this->session->userdata('enrollment_number'); ?>
                            </div>
						</div>
										...
										<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" >
											<div class="header-info2 d-flex align-items-center">
												<div class="header-media">
													<img src="<?php //echo base_url(); ?>assets/student/images/user.jpg" alt="">
												</div>
											</div>
										</a>
									</div>
